...
from inlinenode_markdown import split_nodes_delimiter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_link, text_to_textnodes
...
class TestInlineNodeMarkdown(unittest.TestCase):
    ...
    def test_delimeter_no_delimeter(self):
        old_node = TextNode("This is text with no **code block**", TextType.TEXT)
        delimeter = "`"
        text_type = TextType.CODE
